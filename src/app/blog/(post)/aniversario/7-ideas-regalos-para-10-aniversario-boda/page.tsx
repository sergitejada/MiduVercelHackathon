	...
	return (
		<div>
			...
			<div className="mx-auto mt-10 max-w-4xl">
				...
				<CardProduct
					src={"/assets/joyeria_personalizada.webp"}
				...
				<CardProduct src={"/assets/experiencia_viaje.webp"} title={"Experiencia de Viaje"} description={""} link={""} />
				...
				<CardProduct
					src={"/assets/albumpersonalizado.jpg"}
				...
				<CardProduct src={"/assets/reenovaciondeVotos.webp"} title={"Renovación de Votos"} description={""} link={""} />
				...
				<CardProduct
					src={"/assets/acuarela-retrato.jpg"}
				...
				<CardProduct
					src={"/assets/curso-para-parejas-online.jpg"}
					title={"Clases para Parejas"}
					description={""}
					link={""}
				/>
			</div>
