		...
		<article>
			<ReactCardFlip isFlipped={isFlipped} flipDirection="horizontal">
				<Card
					...
					className={cn(
						"flex h-[28rem] cursor-pointer flex-col justify-between rounded-[10px] border-[3px] border-black bg-white p-[10px] drop-shadow-[-3px_4px_0_rgba(0,0,0,1)]",
				...
				<Card className="flex h-[28rem] flex-col gap-8 transition-none">
