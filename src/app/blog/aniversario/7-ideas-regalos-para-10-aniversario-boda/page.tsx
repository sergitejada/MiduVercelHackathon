		...
		<div className="mx-auto mt-20 flex max-w-7xl flex-row justify-between gap-4">
			<div>
				...
				<div className="mx-auto mt-10 max-w-4xl">
					<p>
						¡Felicidades por tu 10º aniversario! Celebrar una década de amor y compromiso es un logro increíble que
						merece ser conmemorado con un regalo significativo. Aquí te presento algunas ideas de regalos que pueden
						hacer que esta ocasión sea aún más especial:
					</p>
					{/*  */}

					<h3 className="mt-6 font-semibold">1. Joyería Personalizada</h3>
					<p>
						La joyería siempre es un clásico, pero puedes darle un toque especial con personalización. Considera un
						collar o una pulsera con las iniciales de ambos, una fecha significativa o incluso un mensaje grabado. Otra
						opción encantadora es un anillo de aniversario que complemente el anillo de compromiso o las alianzas de
						boda.
					</p>
					...
					<p>
						...
						celebrar. Puedes elegir un destino que siempre hayan querido visitar o regresar al lugar donde pasaron su
						luna de miel. Las experiencias compartidas crean recuerdos duraderos y fortalecen el vínculo.
					</p>
					...
					<CardProduct
						src={"/assets/royal-oak.jpg"}
						title={"Álbum de Fotos Personalizado"}
						description={""}
						link={""}
					/>
					...
					<p>
						Organizar una pequeña ceremonia para renovar sus votos matrimoniales puede ser una manera hermosa de
						reafirmar su compromiso y amor mutuo. Puede ser una ceremonia íntima solo para ustedes dos o una celebración
					...
					<p>
						...
						puede ser una excelente manera de celebrar. Si optas por la cena en casa, puedes decorar el espacio con
						velas, flores y preparar el plato favorito de tu pareja.
					</p>
